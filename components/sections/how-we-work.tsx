          ...
          <div className="mb-6 flex justify-center">
            ...
            >
              ...
              <div className={`relative p-6 rounded-2xl bg-gradient-to-br ${step.gradient} border-2 border-neon-blue/70 shadow-[0_0_50px_rgba(0,240,255,0.5)]`}>
                ...
                <Icon className="w-14 h-14 text-white relative z-10" style={{ 
...
export default function HowWeWork() {
  return (
    <section className="section-padding bg-gradient-to-b from-dark-bg via-dark-surface/30 to-dark-bg relative overflow-hidden">

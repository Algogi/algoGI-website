        ...
        customInput={
          <div className="relative group">
            <input
              ...
              className="w-full px-4 py-3 bg-dark-card border border-neon-blue/30 rounded-lg focus:ring-2 focus:ring-neon-blue focus:border-neon-blue outline-none transition-all duration-200 hover:border-neon-blue/50 text-white placeholder-gray-500 pr-12 cursor-pointer group-hover:shadow-[0_0_15px_rgba(0,240,255,0.2)]"
            />
            <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
              <Calendar className="w-5 h-5 text-neon-blue group-hover:text-neon-cyan transition-colors" />
            </div>
          </div>
        }
      />

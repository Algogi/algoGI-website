    ...
    >
      ...
      >
        ...
        <textarea
          ...
          className="w-full px-4 py-3 bg-dark-card border border-neon-blue/30 rounded-lg focus:ring-2 focus:ring-neon-blue focus:border-neon-blue outline-none resize-none transition-all duration-200 hover:border-neon-blue/50 text-gray-900 dark:text-white placeholder-gray-500"
        />
      </motion.div>

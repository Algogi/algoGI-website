          ...
          >
            <div className="bg-dark-card rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-neon-blue/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-lg text-gray-300 dark:text-gray-300 text-gray-700 mb-8 leading-relaxed">
                  {service.description}
                </p>
                ...
                <ul className="space-y-4">
                  {service.features.map((feature, index) => (
                    ...
                    >
                      <span className="text-neon-blue dark:text-neon-blue text-neon-light-blue mr-3 font-bold text-xl">✓</span>

/**
 * Client-safe work email utilities.
 * Exports helpers used by both client and server code without relying on Node APIs.
 */

// List of common personal and disposable providers we want to block for work emails
...
/**
 * Checks if an email address is a work email (not from a personal provider).
 */

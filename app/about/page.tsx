...
export const metadata: Metadata = {
  title: "About AlgoGI | AI-Powered Engineering Team",
  description:
    "Meet AlgoGI — engineers, designers, and AI specialists delivering secure, scalable, AI-native products and automation for modern businesses.",
...
export default function AboutPage() {
  return (
    <div className="bg-dark-bg relative overflow-hidden">
      ...
      <section className="section-padding relative z-10">
        <div className="container-custom">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 dark:text-gray-300 leading-relaxed max-w-4xl mx-auto">
              We are a group of software innovators, engineers, and designers building future-capable solutions with
              deep expertise in artificial intelligence, product design, and full-cycle development.
            </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-3xl mx-auto">
              We imagine a future where AI-powered technology delivers frictionless, smart, and meaningful experiences.
              Our goal is to drive that change—one solution at a time.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-lg text-gray-400 leading-relaxed">
                  With deep AI and software expertise, we deliver the right mix of innovation and stability to turn
                  digital concepts into production-ready reality.
                </p>
                <p className="text-lg text-gray-400 leading-relaxed">
                  From concept to deployment, we collaborate closely to build scalable, future-ready outcomes that align
                  with business goals and deliver real impact.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {milestones.map((milestone, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="neon-card p-8 rounded-xl border border-neon-cyan/30 dark:border-neon-cyan/30 border-neon-light-blue/40 text-center hover:border-neon-cyan/50 dark:hover:border-neon-cyan/50 hover:border-neon-light-blue/60 transition-all hover:shadow-[0_0_30px_rgba(6,182,212,0.1)]"
                  >
                    <div className="mb-4">
                    ...
                    <div
                      className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-300 dark:from-gray-300 from-gray-700 via-neon-blue/60 dark:via-neon-blue/60 via-neon-light-blue/80 to-gray-400 dark:to-gray-400 to-gray-600 bg-clip-text text-transparent mb-3"
        ...
        <div className="container-custom">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12 max-w-3xl mx-auto space-y-4">
              ...
              <p className="text-lg text-gray-400 leading-relaxed">
                We create a collaborative environment where every team member&apos;s perspectives and talents are valued.
              </p>
            </div>
      ...
      <section className="section-padding relative z-10">
        <div className="container-custom">
          <div className="text-center neon-card rounded-2xl p-12 md:p-16 border border-neon-blue/30 max-w-4xl mx-auto relative overflow-hidden bg-gradient-to-br from-neon-blue/10 dark:from-dark-card via-neon-purple/15 dark:via-dark-surface/50 to-neon-blue/10 dark:to-dark-card">

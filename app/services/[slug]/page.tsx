...
export default function ServiceDetailPage() {
  ...
  if (!service) {
    return (
      <div className="section-padding bg-dark-bg dark:bg-dark-bg bg-light-bg text-center">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Service Not Found</h1>
        <p className="text-gray-400 dark:text-gray-400 text-gray-600 mb-8">The service you&apos;re looking for doesn&apos;t exist.</p>
    ...
    <div className="bg-dark-bg dark:bg-dark-bg bg-light-bg relative overflow-hidden">
      ...
      <section className="section-padding relative z-10">
        <div className="container-custom">
          <Link
            href="/services"
            className="inline-flex items-center gap-2 text-gray-400 dark:text-gray-400 text-gray-600 hover:text-neon-blue dark:hover:text-neon-blue hover:text-neon-light-blue transition-colors mb-8"
          >
          ...
          >
            <div className="mb-6">
              ...
              {service.title.includes("—") && (
                <p className="text-xl md:text-2xl lg:text-3xl text-gray-400 dark:text-gray-400 text-gray-600 font-normal">
        ...
        <div className="container-custom">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <p className="text-lg md:text-xl text-gray-300 dark:text-gray-300 text-gray-700 leading-relaxed">
      ...
      {/* Features Section */}
      <section className="section-padding relative z-10 bg-gradient-to-b from-dark-bg dark:from-dark-bg from-light-bg via-dark-surface/30 dark:via-dark-surface/30 via-light-surface/30 to-dark-bg dark:to-dark-bg to-light-bg">
        <div className="container-custom">
          <div className="max-w-6xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      <CheckCircle2 className="w-6 h-6 text-neon-blue dark:text-neon-blue text-neon-light-blue mb-3 group-hover:scale-110 transition-transform duration-300" />
                      <p className="text-gray-300 dark:text-gray-300 text-gray-700 font-medium flex-1">{feature}</p>
                    </div>
                  </motion.div>
                );
              })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {service.benefits.map((benefit, index) => (
                ...
                >
                  <div className={`absolute inset-0 bg-gradient-to-br ${service.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-300`} />
                  <div className="relative z-10 flex flex-col h-full">
                    <TrendingUp className="w-6 h-6 text-neon-purple dark:text-neon-purple text-neon-light-purple mb-3 group-hover:scale-110 transition-transform duration-300" />
                    <p className="text-gray-300 dark:text-gray-300 text-gray-700 leading-relaxed flex-1">{benefit}</p>
                  </div>
                </motion.div>
              ))}
            </div>
              ...
              {service.useCases.map((useCase, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`absolute inset-0 bg-gradient-to-br ${service.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-300`} />
                    <div className="relative z-10 flex flex-col h-full">
                      <Target className="w-6 h-6 text-neon-cyan dark:text-neon-cyan text-neon-light-blue mb-3 group-hover:scale-110 transition-transform duration-300" />
                      <p className="text-gray-300 dark:text-gray-300 text-gray-700 leading-relaxed flex-1">{useCase}</p>
                    </div>
                  </motion.div>
                );
              })}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-lg md:text-xl text-gray-300 dark:text-gray-300 text-gray-700 mb-10 max-w-2xl mx-auto">
